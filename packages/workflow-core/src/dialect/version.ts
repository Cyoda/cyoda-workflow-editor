 ...
 * `"0.7"`. See `ai/cyoda-schema-versions.md` for how to add a new version.
 */
export type CyodaSchemaVersion = string;

/** The latest cyoda-go schema dialect this library ships. */
export const LATEST_CYODA_VERSION: CyodaSchemaVersion = "0.7";

/** Dialects shipped by this library (host apps may register more at runtime). */
export const SUPPORTED_CYODA_VERSIONS: readonly CyodaSchemaVersion[] = ["0.7"];
